...
*[_type == "page" && slug.current == $slug][0]{
  ...
  sections[]{
    ...
    ...select(
      ...
      _type == "sectionTwoCol" => { heading, reverse, left, right },
      _type == "sectionGallery" => { heading, columns, images },
      _type == "sectionCards" => { heading, items },
      _type == "sectionCTA" => { heading, body, buttons },
      _type == "sectionFAQ" => { heading, items },
      _type == "sectionHTML" => { heading, html },
    )
  }
}
`
